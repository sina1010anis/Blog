...
return [
    ...
    'tag_attributes'               => [
         ...
         * If other elements in your page use tabindex, it should be set to make admin navigation easier.
         */
        'tabindex'         => 0,

        /**
         * The name of your callback function, executed when the admin submits a successful response.
        ...
        /**
         * The name of your callback function, executed when the reCAPTCHA response expires and the admin needs to re-verify.
         * DO NOT SET "biscolabOnloadCallback"
         */
         ...
         * If you specify a function here, you are responsible for informing the admin that they should retry.
         * DO NOT SET "biscolabOnloadCallback"
         */
        'error-callback'   => null,
    ]
