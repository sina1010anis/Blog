    ...
    <div class="view-item-and-slid">
        ...
        <span class="view-slid-style-1">
            <span class="fl-right slid-style-1">
                <ul>
                    <li v-for="i in menu" class="item-menu-style-1 color-b-700" style="padding: 10px;text-align: right"><a class="set-font f-13" :href="'/Iran-Blog/'+name_domain.domain+'/menu/'+i.name">{{i.name }}</a></li>
                    <slot name="view-btn" :user_id="name_domain.user_id" :domain="name_domain.domain"/>
                </ul>
            </span>
            <span class="fl-right slid-style-1">
